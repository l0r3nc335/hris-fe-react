...
import { PayPalPaymentForm } from '@/modules/mySubscription/components/PayPalPaymentForm'
import { StripePaymentForm } from '@/modules/mySubscription/components/StripePaymentForm'
import { TwoCTwoPPaymentForm } from '@/modules/mySubscription/components/TwoCTwoPPaymentForm'
import { useSubscriptionPlans } from '@/modules/mySubscription/hooks'
...
export function PaymentPage(): React.JSX.Element {
  ...
  if (!plan) {
    return (
      <PageShell title="Payment">
        ...
        <Button className="mt-4" variant="outline" onClick={() => navigate(ROUTES.mySubscription)}>
          Back to plans
        </Button>
      </PageShell>
    )
  ...
  return (
    <PageShell
      ...
      breadcrumbs={[
        { label: 'Subscription' },
        { label: 'Plans', path: ROUTES.mySubscription },
